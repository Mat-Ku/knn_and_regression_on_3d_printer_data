...
df = pd.read_csv('*') # insert path do dataset
...
X_train = X_train.drop(['material', 'roughness', 'elongation', 'tension_strength'], axis=1)
...
X_test = X_test.drop(['material', 'roughness', 'elongation', 'tension_strength'], axis=1)
